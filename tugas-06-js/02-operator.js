...
/// Sisa Gaji
const sisaGaji = (5000000 + (5000000 / 100 * 10) + (5000000 / 100 * 5) - (750000 + 2000000 + 1000000 + 250000)); // Jawaban 1
...
const oneInString = "1";
const oneInNumber = 1;
const isSame = oneInString == oneInNumber; // Jawaban 2
console.log(isSame);
...
const studentA = 75;
const studentB = 80;
const isHigher = studentA >= studentB; // Jawaban 3
...
const final = oneInString === oneInNumber; // Jawaban 4
console.log(final);